 ...
 * Copyright: (2018) Francisco Bertolotto, Mauro Santoni
...
static void prueba_instertar_desorden()
{
    abb_t* abb = abb_crear(strcmp,NULL);
    ...
    print_test("Prueba abb insertar elemento", abb_guardar(abb, "N",&numero[6]));
    ...
    print_test("Prueba abb obtener elemento", (num5 == numero[4]));
...
void ejecutar_iterador_interno(abb_t* abb) {
    ...
    print_test("El iterador interno iteró correctamente", contador == 6);
}
