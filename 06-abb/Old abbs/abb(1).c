...
/////////////////////////////////////////////////////////////////////
/* 
Recibe un nodo inicial para poder iterar recursivamente, la clave que se está buscando, un puntero a un booleano que se editará 
en función de si lo encuentra o no, un árbol (se utilizará para obtener la función de comparación) y un puntero a un nodo que se
denomina padre del nodo que se está buscando (se editará dicho puntero para que poseea la dirección del padre si es que se le pasa
por párametro un puntero válido, en caso que sea NULL se entiende que no se desea saber quien es el padre del nodo a buscar).
*/
...
bool abb_guardar(abb_t *arbol, const char *clave, void *dato) {
	...
	//Si lo encuentra solo se actualiza el dato, pero no se aumenta la cantidad.
	buscado->dato = dato;
	//Libero el nodo que cree para insertar, porque no lo necesite.
