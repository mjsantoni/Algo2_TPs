...
static void prueba_crear_hash_vacio()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion VACIO:%f\n",time_spent);
    printf("\n");
    printf("\n");
...
static void prueba_iterar_hash_vacio()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion ITERAR VACIO:%f\n",time_spent);
    printf("\n");
    printf("\n");
}
...
static void prueba_hash_insertar()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion INSTERTAR:%f\n",time_spent);
    printf("\n");
    printf("\n");
}
...
static void prueba_hash_reemplazar()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion REEMPLAZAR:%f\n",time_spent);
    printf("\n");
    printf("\n");
}
...
static void prueba_hash_reemplazar_con_destruir()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion REEMPLAZAR CON DESTRUIR:%f\n",time_spent);
    printf("\n");
    printf("\n");
}
...
static void prueba_hash_borrar()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion BORRAR:%f\n",time_spent);
    printf("\n");
    printf("\n");
}
...
static void prueba_hash_clave_vacia()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion CLAVE VACIA:%f\n",time_spent);
    printf("\n");
    printf("\n");
}
...
static void prueba_hash_valor_null()
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion VALOR NULL:%f\n",time_spent);
    printf("\n");
    printf("\n");
}
...
static void prueba_hash_volumen(size_t largo, bool debug)
{
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion 1:%f\n",time_spent1);
    printf("\n");
    printf("\n");
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion 2:%f\n",time_spent2);
    printf("\n");
    printf("\n");
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion 3:%f\n",time_spent3);
    printf("\n");
    printf("\n");
    ...
    printf("\n");
    printf("\n");
    printf("Tiempo de ejecucion 4:%f\n",time_spent4);
    printf("\n");
    printf("\n");
